...
* [`Base.length` — Method](https://docs.julialang.org/en/v1.6/base/collections/#Base.length)
...
* [Indexing (section)](https://docs.julialang.org/en/v1.6/manual/arrays/#man-array-indexing)
...
* [`Base.zero` — Function](https://docs.julialang.org/en/v1.6/base/numbers/#Base.zero)
...
* [`Base.zeros` — Function](https://docs.julialang.org/en/v1.6/base/arrays/#Base.zeros)
...
* [`Base.one` — Function](https://docs.julialang.org/en/v1.6/base/numbers/#Base.one)
...
* [`Base.ones` — Function](https://docs.julialang.org/en/v1.6/base/arrays/#Base.ones)
...
* [`Random.rand` — Function](https://docs.julialang.org/en/v1.6/stdlib/Random/#Base.rand)
...
* [`Base.Random.randn` — Function](hhttps://docs.julialang.org/en/v1.6/stdlib/Random/#Base.randn)
...
* [`Base.sum` — Function](https://docs.julialang.org/en/v1.6/base/collections/#Base.sum)
...
* [Repeated Evaluation: Loops](https://docs.julialang.org/en/v1.6/manual/control-flow/#Control-Flow)
